...
function ProfilePage() {
  ...
  useEffect(() => {
    ...
    fetchBlogs("http://docker-alb-be-1961992740.us-west-2.elb.amazonaws.com:9090/blogs", token);
    fetchForums("http://docker-alb-be-1961992740.us-west-2.elb.amazonaws.com:9090/forums", token);
    fetchData();
  ...
  const handleSubmit = async (e) => {
    ...
    await axios
      .patch("http://docker-alb-be-1961992740.us-west-2.elb.amazonaws.com:9090/user/update-profile", data, {
        headers: {
          "Content-Type": "multipart/form-data",
          Authorization: `Bearer ${token}`,
        },
