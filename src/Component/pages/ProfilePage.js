...
function ProfilePage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      await axios
        .get("http://34.210.194.44:9090/user/profile", {
          headers: {
    ...
    fetchBlogs("http://34.210.194.44:9090/blogs", token);
    fetchForums("http://34.210.194.44:9090/forums", token);
    fetchData();
  ...
  const handleSubmit = async (e) => {
    ...
    await axios
      .patch("http://34.210.194.44:9090/user/update-profile", data, {
        headers: {
          "Content-Type": "multipart/form-data",
          Authorization: `Bearer ${token}`,
        },
